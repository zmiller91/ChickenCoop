...
public class WeatherForecastFetcher {
    ...
    private void fetchForComponent(CoopState coop, ComponentState component) throws Exception {
        ...
        String url = String.format(
                "https://api.open-meteo.com/v1/forecast?latitude=%s&longitude=%s&hourly=precipitation_probability,precipitation&timeformat=unixtime&timezone=UTC&forecast_days=2",
                latitude, longitude);
