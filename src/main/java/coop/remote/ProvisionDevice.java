...
public class ProvisionDevice {
    ...
    public static void main(String... args) throws Exception {
        ...
        PiMqttClient mqtt = new PiMqttClient(clientEndpoint, thingClientId, certificateFile, privateKeyFile);
        mqtt.connect();
        ...
        mqtt.publish(new PiMqttMessage(topic, shadowRequest));

        // publish() is async - give it a moment to actually flush before the process exits.
        Thread.sleep(2000);
    }
    ...
    private static String policy(String coopName, String clientName) {
        return String.format("{\n" +
                ...
                "        \"iot:Receive\"\n" +
                "      ],\n" +
                "      \"Resource\": \"arn:aws:iot:us-east-1:547228847576:topic/hub_command/%s\"\n" +
                "    },\n" +
                "    {\n" +
                "      \"Effect\": \"Allow\",\n" +
                "      \"Action\": \"iot:Subscribe\",\n" +
                "      \"Resource\": [\n" +
                "        \"arn:aws:iot:us-east-1:547228847576:topicfilter/$aws/things/%s/*\",\n" +
                "        \"arn:aws:iot:us-east-1:547228847576:topicfilter/hub_command/%s\"\n" +
                "      ]\n" +
                "    },\n" +
                "    {\n" +
                "      \"Effect\": \"Allow\",\n" +
                ...
                "    }\n" +
                "  ]\n" +
                "}", coopName, coopName, coopName, coopName, clientName);
    }
}
