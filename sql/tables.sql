...
CREATE TABLE IF NOT EXISTS `metrics` (
 ...
 CREATE TABLE IF NOT EXISTS `rule_trigger_component` (
    ...
    CONSTRAINT `RULE_TRIGGER_COMPONENT_FK1` FOREIGN KEY (`COMPONENT_ID`) REFERENCES `components` (`COMPONENT_ID`),
    CONSTRAINT `RULE_TRIGGER_COMPONENT_FK2` FOREIGN KEY (`RULE_ID`) REFERENCES `rule` (`RULE_ID`)
 );
 ...
 CREATE TABLE IF NOT EXISTS `rule_trigger_schedule` (
    ...
    CONSTRAINT `RULE_TRIGGER_SCHEDULE_FK1` FOREIGN KEY (`RULE_ID`) REFERENCES `rule` (`RULE_ID`)
 );
 ...
 CREATE TABLE IF NOT EXISTS `rule_action` (
    ...
    CONSTRAINT `RULE_ACTION_FK1` FOREIGN KEY (`COMPONENT_ID`) REFERENCES `components` (`COMPONENT_ID`),
    CONSTRAINT `RULE_ACTION_FK2` FOREIGN KEY (`RULE_ID`) REFERENCES `rule` (`RULE_ID`)
 );
